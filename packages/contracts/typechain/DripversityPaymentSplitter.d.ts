...
interface DripversityPaymentSplitterInterface extends ethers.utils.Interface {
  functions: {
...
export class DripversityPaymentSplitter extends BaseContract {
  ...
  interface: DripversityPaymentSplitterInterface;

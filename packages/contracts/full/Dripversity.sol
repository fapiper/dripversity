...
// File contracts/Dripversity.sol

// SPDX-License-Identifier: MIT
pragma solidity ^0.8.13;

// @author Decentum
// @title Dripversity (DRIP)

contract Dripversity is Ownable, Pausable, ReentrancyGuard, ERC721A, EIP712 {
    using Strings for uint256;
    ...
    ) ERC721A("Dripversity", "DRIP") EIP712(_signerAddress, "Dripversity") {
        baseURI = _baseURI;
    ...
    function whitelistMint(
        ...
        require(
            sellingPhase == Phase.WhitelistSale,
    ...
    function airDrop(address _to, uint256 _quantity) external onlyOwner {
        require(
            totalSupply() + _quantity < MAX_SUPPLY + 1,
            "Reached max Supply"
        );
    ...
    function withdraw() external nonReentrant {
        (bool success, ) = payable(paymentSplitter).call{

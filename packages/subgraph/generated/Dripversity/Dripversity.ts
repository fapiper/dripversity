...
export class Dripversity extends ethereum.SmartContract {
  static bind(address: Address): Dripversity {
    return new Dripversity("Dripversity", address);
  }
  ...
  amountNFTsPerWalletWhitelistSale(param0: Address): BigInt {
    let result = super.call(
      "amountNFTsPerWalletWhitelistSale",
      "amountNFTsPerWalletWhitelistSale(address):(uint256)",
  ...
  try_amountNFTsPerWalletWhitelistSale(
    param0: Address
  ...
  maxReserved(): BigInt {
    let result = super.call("maxReserved", "maxReserved():(uint256)", []);

    return result[0].toBigInt();
  }

  try_maxReserved(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("maxReserved", "maxReserved():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  sellingPhase(): i32 {
    let result = super.call("sellingPhase", "sellingPhase():(uint8)", []);

    return result[0].toI32();
  }

  try_sellingPhase(): ethereum.CallResult<i32> {
    let result = super.tryCall("sellingPhase", "sellingPhase():(uint8)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
...
export class SetMaxReservedCall extends ethereum.Call {
  get inputs(): SetMaxReservedCall__Inputs {
    return new SetMaxReservedCall__Inputs(this);
  }

  get outputs(): SetMaxReservedCall__Outputs {
    return new SetMaxReservedCall__Outputs(this);
  }
}

export class SetMaxReservedCall__Inputs {
  _call: SetMaxReservedCall;

  constructor(call: SetMaxReservedCall) {
    this._call = call;
  }

  get _maxReserved(): BigInt {
    return this._call.inputValues[0].value.toBigInt();
  }
}

export class SetMaxReservedCall__Outputs {
  _call: SetMaxReservedCall;

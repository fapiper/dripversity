<template>
    ...
    >
        <div
            ref="letterRef"
            class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex items-center"
        >
            <DripversityIcon
                v-for="i in 4"
                :key="i"
                class="text-transparent stroke-1 stroke-blue/20 h-40 flex-shrink-0"
            />
        </div>
    </div>
</template>
